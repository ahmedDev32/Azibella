...
import {  IoHeartSharp, IoMedicalSharp  } from 'react-icons/io5'; // Adjusted icons imported
...
const Index = () => {
  ...
  const iconArr = [
    { Icon: IoMedicalSharp, Text: "Surgical", href :"/Products?p=Surgical"},
    { Icon: IoMedicalSharp, Text: "Dental" ,href :"/Products?p=Surgical" },
    { Icon: IoHeartSharp, Text: "Beauty", href :"/Products?p=Surgical"}
  ];
        ...
        <div className="mt-5 mb-3 flex flex-wrap justify-center">
          {
            iconArr.map((Icon,Index)=>{
              return <CircleIon  key={Index} Icon={Icon.Icon} Text={Icon.Text} href = {Icon.href}/>
            })
          }
         </div>
      </div>
    ...
    <div className="flex flex-wrap my-4 justify-between">
  {
    ...
    <div className="mt-5 flex flex-col">
     ...
     <div className="mt-4 mx-3">
      ...
      {
  products && products.length > 0 && products.slice(0, 6).map((data, index) => {
