...
const ImageList = [
  {
    id: 1,
    img: "/images/s6.png",
    title: "15% off for first order",
    description:
      "Discover our range of products.",
    link: "/Products?p=All", // Link for surgical products
  },
  {
    id: 2,
    img: "/images/h2.png",
    title: "10k + custom orders",
    description:
      "High-quality instruments designed for precision and durability.",
    link: "/Products?p=All", // Link for clothing
  },
  {
    id: 3,
    ...
    description:
      "Premium tweezers and grooming tools for personal care.",
    link: "/Products?p=All", // Link for sports wear
  },
];
